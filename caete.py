...
def catch_out_budget(out):
    lst = ["evavg", "epavg", "phavg", "aravg", "nppavg",
           ...
           "limitation_status", "uptk_strat", 'cp', 'c_cost_cwm']   #, 'nppavg_pft']
...
class grd:
    ...
    def _allocate_output(self, n, npls=npls):
        ...
        # self.nppday = np.zeros(shape=(n,), order='F')
        ...
        self.testing = np.zeros(shape=(n,), order='F')
        ...
        for s in range(spin):
            ...
            for step in range(steps.size):
                ...
                for n in self.vp_lsid:
                    ...
                    # nppday[n] = 3.
                    # print('testing', testing[n],'N', n, self.vp_lsid.size)
                ...
                # print('lsid',self.vp_lsid, self.vp_lsid.size)
                ...
                if self.vp_lsid.size < 1 and not save:
                    ...
                    # self.nppday = daily_output['nppavg_pft'][self.vp_lsid]

                    # print('cleaf', self.vp_cleaf, self.vp_lsid)
                ...
                if save:
                    ...
                    # self.nppday[step] = daily_output['nppavg_pft']
